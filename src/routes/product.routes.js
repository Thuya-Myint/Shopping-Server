...
const { createProduct, getAllProducts, getProductByCategory, batchCreateProduct, getProductByDiscountPercent, getProductWithDiscount, updateProduct, deleteProduct, getProductsByShopId } = require("../controllers/product.controller")
